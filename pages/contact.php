                ...
                <div class="contact-box" style="background:white;padding:40px;border-radius:16px;box-shadow:0 10px 30px rgba(0,0,0,.08);">
                    ...
                    <div style="space-y:15px;">
                        <div style="display:flex;align-items:center;gap:15px;">
                            <img src="<?= asset('/images/facebook.png') ?>" alt="Facebook" width="25">
                            <a href="https://www.facebook.com/thieunhithoidai" target="_blank" style="color:#0D2488;font-weight:600;margin-bottom:10px;">facebook.com/thieunhithoidai</a>
                        </div>
                        <div style="display:flex;align-items:center;gap:15px;">
                            <img src="<?= asset('/images/instagram.png') ?>" alt="Instagram" width="25">
                            <a href="https://www.instagram.com/thieunhithoidai.official/" target="_blank" style="color:#0D2488;font-weight:600;margin-bottom:10px;margin-top:10px;">@thieunhithoidai.official</a>
                        </div>
                        <div style="display:flex;align-items:center;gap:15px;">
                            <svg width="25" height="25" viewBox="0 0 24 24" fill="#EB0452"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>
                            <a href="mailto:thieunhithoidai@thieunhithoidai.org" style="color:#0D2488;font-weight:600;margin-bottom:10px;margin-top:10px;">thieunhithoidai@thieunhithoidai.org</a>
                        </div>
                    </div>
